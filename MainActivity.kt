...
class MainActivity : AppCompatActivity() {
    private val monsters: List<Monster> =listOf(
        Monster("You matched Nairobi!", R.drawable.monster1_head, R.drawable.monster1_body,R.drawable.monster1_feet),
        Monster("You matched Vibha!", R.drawable.monster2_head, R.drawable.monster2_body,R.drawable.monster2_feet),
        Monster("You matched Anurag!", R.drawable.monster3_head, R.drawable.monster3_body,R.drawable.monster3_feet)
    )
